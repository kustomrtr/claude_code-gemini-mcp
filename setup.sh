...
echo ""
echo "Optional: Set GEMINI_MODEL env var to use a different model"
echo "  Default: gemini-3-flash-preview"
echo "  Example: export GEMINI_MODEL=gemini-3-pro-preview"
echo ""
echo "Enjoy!"